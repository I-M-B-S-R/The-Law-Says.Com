...
export const SAFFORD_CODE_CONTENT: Record<string, CodeContent> = {
  '1': {
    summary: "Title I of the Safford City Code establishes the foundational legal framework for the entire code. It provides rules for interpretation, defines common terms, and specifies the general penalty for violations where a specific penalty is not otherwise stated.",
  ...
  '5': {
    ...
    keyProvisions: [
      ...
      },
      {
        ...
        content: "Contains regulations for connecting to and using the city's water, gas, and sewer utilities to protect public health and ensure system integrity."
      }
    ]
  },
  '7': {
    summary: "Title VII is the Safford Traffic Code. It adopts state traffic laws and establishes additional local regulations for vehicle operation and parking.",
    purpose: "To provide for the safe and orderly movement of vehicular and pedestrian traffic within the City of Safford.",
    keyProvisions: [
      {
    ...
    keyProvisions: [
      {
        ...
        content: "Requires most businesses operating in Safford to obtain a City Business License."
      },
      {
  ...
  '13': {
    ...
    purpose: "To define and prohibit conduct that is harmful to public peace, safety, and order within the City of Safford.",
    keyProvisions: [
      {
