...
export const EAGAR_CODE_CONTENT: Record<string, CodeContent> = {
  '1': {
    summary: "Title 1 of the Eagar Town Code establishes the foundational legal framework for the entire code. It provides rules for interpretation, defines common terms, and specifies the general penalty for violations where a specific penalty is not provided.",
  ...
  '3': {
    summary: "Title 3, Administration, details the structure and organization of Eagar's town government. It defines the roles and responsibilities of the Town Council, Town Manager, and various departments.",
  ...
  '7': {
    summary: "Title 7 is the Eagar Traffic Code. It adopts state traffic laws and establishes additional local regulations for vehicle operation and parking.",
    purpose: "To provide for the safe and orderly movement of vehicular and pedestrian traffic within the Town of Eagar.",
    keyProvisions: [
      {
      ...
      },
      {
        ...
        content: "Prohibits parking in certain areas, such as in front of fire hydrants, in loading zones, or on sidewalks."
      }
    ]
  },
  '9': {
    ...
    keyProvisions: [
      {
        ...
        content: "Requires most businesses operating in Eagar to obtain a Town Business License."
      },
      {
  ...
  '13': {
    summary: "Title 13, General Offenses, defines various local-level criminal and civil offenses to maintain public order and safety within the town.",
    purpose: "To define and prohibit conduct that is harmful to public peace, safety, and order within the Town of Eagar.",
    keyProvisions: [
      {
  ...
  '15': {
    summary: "Title 15, Land Usage, contains the comprehensive Zoning and Subdivision regulations for the town. It is the primary tool for managing growth and ensuring development aligns with the town's character.",
