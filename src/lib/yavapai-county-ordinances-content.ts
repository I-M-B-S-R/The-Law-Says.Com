...
export const YAVAPAI_COUNTY_ORDINANCES_CONTENT: Record<string, OrdinanceContent> = {
  'planning-zoning': {
    summary: "The Yavapai County Planning and Zoning Ordinance governs land use and development within the unincorporated areas of the county. It establishes zoning districts, regulations for land use, and procedures for obtaining development approvals. The full text can be found at the <a href='https://yavapaiaz.gov/' target='_blank' rel='noopener noreferrer' class='text-primary underline'>Yavapai County website</a>.",
  ...
  'fire-code': {
    summary: "The Yavapai County Fire Code Ordinance adopts a modified version of the International Fire Code to reduce the risk of fire and improve life safety. It sets standards for fire prevention, fire protection systems, and access for emergency responders. The full code is available at the <a href='https://yavapaiaz.gov/' target='_blank' rel='noopener noreferrer' class='text-primary underline'>Yavapai County website</a>.",
  ...
  'outdoor-lighting': {
    summary: "The Yavapai County Outdoor Lighting Ordinance, also known as the 'Dark Sky' ordinance, is designed to protect the dark night skies that are a valuable natural resource in the region. It regulates outdoor lighting fixtures to minimize light pollution, glare, and light trespass. The ordinance is available on the <a href='https://yavapaiaz.gov/' target='_blank' rel='noopener noreferrer' class='text-primary underline'>Yavapai County website</a>.",
  ...
  'grading': {
    summary: "The Yavapai County Grading Ordinance regulates the movement of earth (grading, excavation, and filling) on properties within the unincorporated county. It is designed to control soil erosion, protect drainage channels, and prevent hazards related to unstable slopes. Find the full ordinance on the <a href='https://yavapaiaz.gov/' target='_blank' rel='noopener noreferrer' class='text-primary underline'>Yavapai County website</a>.",
  ...
  'rv-tiny-home': {
    summary: "This ordinance provides regulations for the use of Recreational Vehicles (RVs) and tiny homes as residences in certain parts of unincorporated Yavapai County. It addresses a growing interest in alternative housing types while balancing neighborhood character and safety. The full ordinance is available at the <a href='https://yavapaiaz.gov/' target='_blank' rel='noopener noreferrer' class='text-primary underline'>Yavapai County website</a>.",
