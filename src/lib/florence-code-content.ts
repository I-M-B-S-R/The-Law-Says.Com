...
export const FLORENCE_CODE_CONTENT: Record<string, CodeContent> = {
  '1': {
    summary: "Title I of the Florence Town Code establishes the foundational legal framework for the entire code. It provides rules for interpretation, defines common terms, and specifies the general penalty for violations where a specific penalty is not otherwise stated.",
  ...
  '3': {
    summary: "Title III, Administration, details the structure and organization of the town government. It defines the roles and responsibilities of the Town Council, town manager, and various city departments.",
  ...
  '7': {
    summary: "Title VII is the Florence Traffic Code. It adopts state traffic laws and establishes additional local regulations for vehicle operation and parking.",
    purpose: "To provide for the safe and orderly movement of vehicular and pedestrian traffic within the Town of Florence.",
    keyProvisions: [
      {
    ...
    keyProvisions: [
      {
        ...
        content: "Requires most businesses operating in Florence to obtain a Town Business License."
      },
      {
  ...
  '13': {
    ...
    purpose: "To define and prohibit conduct that is harmful to public peace, safety, and order within the Town of Florence.",
    keyProvisions: [
      {
  ...
  '15': {
    summary: "Title XV, Land Development Code, contains the comprehensive Zoning and Subdivision regulations for the town. It is the primary tool for managing growth and ensuring development aligns with the town's historic character.",
    ...
    keyProvisions: [
      ...
      },
      {
        ...
        content: "Includes regulations aimed at preserving the unique historic character of Florence's downtown and residential historic districts."
      },
      {
