...
export const WILLIAMS_CODE_CONTENT: Record<string, CodeContent> = {
  '1': {
    summary: "Title I of the Williams City Code establishes the foundational legal framework for the entire code. It provides rules for interpretation, defines common terms, and specifies the general penalty for violations where a specific penalty is not otherwise stated.",
  ...
  '7': {
    summary: "Title VII is the Williams Traffic Code. It adopts state traffic laws and establishes additional local regulations for vehicle operation and parking.",
    purpose: "To provide for the safe and orderly movement of vehicular and pedestrian traffic within the City of Williams, the 'Gateway to the Grand Canyon'.",
    keyProvisions: [
      {
      ...
      },
      {
        ...
        content: "Prohibits parking in certain areas and for extended periods on public streets to ensure safety and access, especially in the historic downtown area."
      }
    ]
  },
  '9': {
    ...
    keyProvisions: [
      {
        ...
        content: "Requires most businesses operating in Williams to obtain a City Business License."
      }
    ]
  },
  '13': {
    ...
    purpose: "To define and prohibit conduct that is harmful to public peace, safety, and order within the City of Williams.",
    keyProvisions: [
      {
  ...
  '15': {
    summary: "Title XV, Land Usage, contains the comprehensive Zoning and Subdivision regulations for the city. It is the primary tool for managing growth and ensuring development aligns with the city's historic and tourism-oriented character.",
    purpose: "To guide the physical development of the city in a manner that promotes public health and safety, preserves its historic resources, and ensures orderly growth.",
    keyProvisions: [
      {
        title: "Zoning Districts",
        content: "Establishes various residential, commercial, and industrial zoning districts, including a specific historic business district, and specifies the permitted uses for each."
      },
      {
        title: "Historic Preservation",
        content: "Includes regulations aimed at preserving the unique historic character of Williams' downtown, which is a key part of its identity as a Route 66 town."
      }
    ]
  }
};
