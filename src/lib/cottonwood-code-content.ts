...
export const COTTONWOOD_CITY_CODE_CONTENT: Record<string, CodeContent> = {
  '1': {
    summary: "Title 1 of the Cottonwood City Code establishes the foundational legal framework for the entire code. It provides rules for interpretation, defines common terms, and specifies the general penalty for violations where a specific penalty is not otherwise stated.",
  ...
  '2': {
    summary: "Title 2, Administration, details the structure and organization of Cottonwood's city government. It defines the roles and responsibilities of the City Council, city manager, and various city departments, boards, and commissions.",
    ...
    keyProvisions: [
      {
        ...
        content: "The City operates under a Council-Manager form of government. The City Council is the legislative body, while the City Manager, appointed by the Council, serves as the chief executive officer responsible for daily operations."
      },
      {
        title: "City Council",
      ...
      },
      {
        ...
        content: "Provides for the creation of citizen advisory bodies such as the Planning and Zoning Commission and the Historic Preservation Commission to provide recommendations to the City Council."
      }
    ]
  },
  '3': {
    summary: "Title 3, Finance and Taxation, governs the city's fiscal procedures. It covers the budget process, purchasing, and the collection of taxes, including the local Transaction Privilege (Sales) Tax.",
  ...
  '4': {
    summary: "Title 4, Business and License Regulations, governs the licensing and operation of various businesses within the city to ensure they operate in a fair and safe manner.",
    ...
    keyProvisions: [
      {
        ...
        content: "Requires most businesses operating in Cottonwood to obtain a City Business License."
      },
      {
  ...
  '5': {
    summary: "Title 5, Health and Sanitation, covers a wide range of rules related to public health and welfare, including nuisance abatement and solid waste disposal.",
    ...
    keyProvisions: [
      {
        ...
        content: "Declares conditions like overgrown weeds, accumulation of trash, and stagnant water to be public nuisances and provides a process for their abatement."
      },
      {
        title: "Solid Waste",
  ...
  '7': {
    summary: "Title 7, Peace, Morals and Welfare, defines various local-level public order offenses to maintain a peaceful and safe community.",
    ...
    keyProvisions: [
      ...
      },
      {
      ...
      },
       {
        ...
        content: "Includes regulations aimed at preserving the unique historic character of areas like Old Town Cottonwood."
      }
    ]
  }
};
