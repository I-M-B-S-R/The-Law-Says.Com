...
export const SAN_LUIS_CODE_CONTENT: Record<string, CodeContent> = {
  '1': {
    summary: "Chapter 1 of the San Luis City Code establishes the foundational legal framework for the entire code. It provides rules for interpretation, defines common terms, and specifies the general penalty for violations where a specific penalty is not provided.",
  ...
  '4': {
    summary: "Chapter 4, Alcoholic Beverages, governs the sale and consumption of liquor within the City of San Luis.",
    ...
    keyProvisions: [
      ...
      },
      {
        ...
        content: "Applications for a state liquor license for a location within San Luis are forwarded to the City Council for a recommendation to the State Liquor Board."
      }
    ]
  },
  '6': {
    summary: "Chapter 6, Animal Control, establishes the rules for the keeping of animals within the city to protect public safety and ensure animal welfare.",
  ...
  '8': {
    summary: "Chapter 8, Buildings and Construction, adopts the set of codes that govern all building and construction within the city.",
    ...
    keyProvisions: [
      {
        ...
        content: "Requires most businesses operating in San Luis to obtain a City Business License."
      },
      {
