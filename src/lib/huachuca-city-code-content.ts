...
export const HUACHUCA_CITY_CODE_CONTENT: Record<string, CodeContent> = {
  '1': {
    summary: "Title I of the Huachuca City Town Code establishes the foundational legal framework for the entire code. It provides rules for interpretation, defines common terms, and specifies the general penalty for violations where a specific penalty is not otherwise stated.",
  ...
  '7': {
    summary: "Title VII is the Huachuca City Traffic Code. It adopts state traffic laws and establishes additional local regulations for vehicle operation and parking.",
    purpose: "To provide for the safe and orderly movement of vehicular and pedestrian traffic within the Town of Huachuca City.",
    keyProvisions: [
      {
  ...
  '11': {
    ...
    purpose: "To provide for the regulation of businesses to protect the public health, safety, and welfare, particularly given the town's proximity to Fort Huachuca.",
    keyProvisions: [
      {
        title: "Business Licenses",
        content: "Requires most businesses operating in Huachuca City to obtain a Town Business License."
      },
      {
  ...
  '13': {
    ...
    purpose: "To define and prohibit conduct that is harmful to public peace, safety, and order within the Town of Huachuca City.",
    keyProvisions: [
      {
  ...
  '15': {
    summary: "Title XV, Land Usage, contains the comprehensive Zoning and Subdivision regulations for the town. It is the primary tool for managing growth and ensuring development aligns with the town's character and its relationship with the adjacent Fort Huachuca.",
    purpose: "To guide the physical development of the town in a manner that promotes public health and safety, ensures orderly growth, and is compatible with the operations of Fort Huachuca.",
    keyProvisions: [
      {
