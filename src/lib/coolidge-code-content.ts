...
export const COOLIDGE_CODE_CONTENT: Record<string, CodeContent> = {
  '1': {
    summary: "Title 1 of the Coolidge City Code establishes the foundational legal framework for the entire code. It provides rules for interpretation, defines common terms, and specifies the general penalty for violations where a specific penalty is not otherwise stated.",
  ...
  '2': {
    summary: "Title 2, Administration and Personnel, details the structure and organization of Coolidge's city government. It defines the roles and responsibilities of the City Council, city manager, and various city departments, boards, and commissions.",
    ...
    keyProvisions: [
      ...
      },
      {
        ...
        content: "Provides for the creation of citizen advisory bodies to provide recommendations and public input to the City Council."
      }
    ]
  },
  '3': {
    ...
    keyProvisions: [
      {
        ...
        content: "Requires most businesses operating in Coolidge to obtain a City Business License."
      },
      {
    ...
    keyProvisions: [
      {
        ...
        content: "Requires all dogs to be licensed and vaccinated against rabies."
      },
      {
