...
export const ELOY_CODE_CONTENT: Record<string, CodeContent> = {
  '1': {
    summary: "Title I of the Eloy City Code establishes the foundational legal framework for the entire code. It provides rules for interpretation, defines common terms, and specifies the general penalty for violations where a specific penalty is not otherwise stated.",
  ...
  '7': {
    summary: "Title VII is the Eloy Traffic Code. It adopts state traffic laws and establishes additional local regulations for vehicle operation and parking.",
    purpose: "To provide for the safe and orderly movement of vehicular and pedestrian traffic within the City of Eloy.",
    keyProvisions: [
      {
    ...
    keyProvisions: [
      {
        ...
        content: "Requires most businesses operating in Eloy to obtain a City Business License."
      },
      {
  ...
  '13': {
    ...
    purpose: "To define and prohibit conduct that is harmful to public peace, safety, and order within the City of Eloy.",
    keyProvisions: [
      {
