...
export const ARIZONA_REVISED_STATUTES_CONTENT: Record<string, LawContent> = {
  ...
  '47': {
    summary: "Title 47 of the Arizona Revised Statutes, found at <a href='https://www.azleg.gov/ars/47/' target='_blank' rel='noopener noreferrer' class='text-primary underline'>A.R.S. Title 47</a>, is Arizona's adoption of the Uniform Commercial Code (UCC). The UCC is a comprehensive set of laws governing commercial transactions. While it is a state law, it has been adopted (with minor variations) by all 50 states to create consistency in commerce across state lines.",
    keyProvisions: [
      {
        title: "Article 2: Sales",
        content: "Governs contracts for the sale of goods (movable property). It provides rules on contract formation, warranties (like the implied warranty of merchantability), and remedies for breach of contract."
      },
      {
        title: "Article 3: Negotiable Instruments",
        content: "Deals with checks, promissory notes, and other 'negotiable instruments.' It sets forth the rights and obligations of parties to these instruments and rules for their transfer and enforcement."
      },
      {
        title: "Article 4: Bank Deposits and Collections",
        content: "Governs the relationship between banks and their customers, including the rules for processing checks and other items."
      },
      {
        title: "Article 9: Secured Transactions",
        content: "This is a critically important article that governs security interests in personal property. When a lender takes an interest in collateral to secure a loan (like a car loan), Article 9 provides the rules for creating, perfecting (making public), and enforcing that security interest."
      }
    ],
    purpose: "The purpose of Title 47 is to simplify, clarify, and modernize the law governing commercial transactions in Arizona and to make that law uniform with other states. This uniformity provides certainty and predictability for businesses, which is essential for a healthy economy."
  },
  '48': {
