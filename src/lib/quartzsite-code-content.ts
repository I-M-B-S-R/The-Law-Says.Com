...
export const QUARTZSITE_CODE_CONTENT: Record<string, CodeContent> = {
  '1': {
    summary: "Title I of the Quartzsite Town Code establishes the foundational legal framework for all other titles. It provides rules for interpreting the code, defines common terms, and specifies the general penalty for violations where a specific penalty is not otherwise stated.",
  ...
  '7': {
    summary: "Title VII is the Quartzsite Traffic Code. It adopts state traffic laws and establishes additional local regulations for vehicle operation and parking, crucial for managing traffic during the town's busy winter season.",
    purpose: "To provide for the safe and orderly movement of vehicular and pedestrian traffic within the Town of Quartzsite.",
    keyProvisions: [
      {
      ...
      },
      {
        ...
        content: "Prohibits parking in certain areas and for extended periods on public streets to ensure safety and access, especially during the major gem and mineral shows."
      },
      {
        title: "Off-Road Vehicles",
        content: "Regulates the operation of OHVs on public streets, providing access to surrounding recreational areas."
      }
    ]
  },
  '9': {
  ...
  '11': {
    summary: "Title XI, Business Regulations, governs the licensing and operation of various businesses within the town, with a focus on the many seasonal vendors and events.",
    purpose: "To provide for the regulation of businesses to protect the public health, safety, and welfare.",
    keyProvisions: [
      {
        title: "Business Licenses",
        content: "Requires most businesses operating in Quartzsite, including seasonal vendors, to obtain a Town Business License."
      },
      {
        title: "Special Events",
        content: "A Special Event Permit is required for the large gem shows and other temporary events that define the town's winter economy."
      }
    ]
  },
  '13': {
    ...
    purpose: "To define and prohibit conduct that is harmful to public peace, safety, and order within the Town of Quartzsite.",
    keyProvisions: [
      {
  ...
  '15': {
    summary: "Title XV, Land Usage, contains the comprehensive Zoning and Subdivision regulations for the town. It is the primary tool for managing growth and ensuring development aligns with the town's unique desert environment and seasonal population.",
    ...
    keyProvisions: [
      {
        ...
        content: "Establishes various residential, commercial, and industrial zoning districts, including special zones for RV parks and large-scale vending areas, and specifies the permitted uses for each."
      },
      {
