...
export const SIERRA_VISTA_CODE_CONTENT: Record<string, CodeContent> = {
  '10': {
    summary: "Chapter 10 of the Sierra Vista City Code establishes the foundational legal framework for the entire code. It provides rules for interpretation, defines common terms, and specifies the general penalty for violations where a specific penalty is not provided.",
  ...
  '30': {
    summary: "Chapter 30, Administration, details the structure and organization of the city government. It defines the roles and responsibilities of the City Council, city manager, and various city departments.",
  ...
  '50': {
    summary: "Chapter 50, Public Ways and Property, governs the essential infrastructure and services managed by the city, including regulations for streets, parks, and public property.",
  ...
  '70': {
    summary: "Chapter 70 is the Sierra Vista Traffic Code. It adopts state traffic laws and establishes additional local regulations for vehicle operation and parking.",
    purpose: "To provide for the safe and orderly movement of vehicular and pedestrian traffic within the City of Sierra Vista.",
    keyProvisions: [
      {
  ...
  '110': {
    summary: "Chapter 110, Business Regulations, governs the licensing and operation of various businesses within the city.",
    purpose: "To provide for the regulation of businesses to protect the public health, safety, and welfare.",
    keyProvisions: [
      {
        title: "Business Licenses",
        content: "Requires most businesses operating in Sierra Vista to obtain a City Business License."
      },
      {
  ...
  '130': {
    summary: "Chapter 130, General Offenses, defines various local-level criminal and civil offenses to maintain public order and safety.",
    purpose: "To define and prohibit conduct that is harmful to public peace, safety, and order within the City of Sierra Vista.",
    keyProvisions: [
      {
  ...
  '150': {
    summary: "Chapter 150, Building Regulations, adopts the set of codes that govern all building and construction within the city.",
  ...
  '151': {
    summary: "Chapter 151, the Development Code, is the city's comprehensive ordinance for land use, combining zoning and subdivision regulations.",
    purpose: "To guide the physical development of the city in a manner that promotes public health, safety, and welfare, while protecting the city's environment and ensuring orderly growth.",
    keyProvisions: [
      {
