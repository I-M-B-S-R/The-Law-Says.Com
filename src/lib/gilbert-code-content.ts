...
export const GILBERT_CODE_CONTENT = {
  ...
  '30': {
    ...
    keyProvisions: [
      ...
      'Mandates paving or dust-proofing of parking areas for non-residential and large residential uses to prevent fugitive dust emissions exceeding 20% opacity.',
      'Prohibits use of leaf blowers to blow debris into roads.',
