...
export const LAKE_HAVASU_CITY_CODE_CONTENT: Record<string, CodeContent> = {
  '1': {
    summary: "Title 1 of the Lake Havasu City Code establishes the foundational legal framework for all other titles. It provides rules for interpretation, defines common terms, and specifies the general penalty for violations where a specific penalty is not otherwise stated.",
    ...
    keyProvisions: [
      {
        ...
        content: "Requires most businesses operating in Lake Havasu City to obtain a City Business License."
      },
      {
        title: "Special Events",
        content: "A permit is required for temporary events that affect ordinary public access or services, such as boat regattas, festivals, and parades."
      }
    ]
  },
  '6': {
