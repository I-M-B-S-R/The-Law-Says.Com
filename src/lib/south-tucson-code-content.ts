...
export const SOUTH_TUCSON_CODE_CONTENT: Record<string, CodeContent> = {
  '1': {
    summary: "Chapter 1 of the South Tucson City Code establishes the foundational legal framework for the entire code. It provides rules for interpretation, defines common terms, and specifies the general penalty for violations where a specific penalty is not provided.",
    ...
    keyProvisions: [
      {
        ...
        content: "Requires most businesses operating in South Tucson to obtain a City Business License."
      },
      {
  ...
  '14': {
    ...
    purpose: "To guide the physical development of the city in a manner that promotes public health, safety, and welfare, and ensures orderly growth that is consistent with the city's unique, multicultural character.",
    keyProvisions: [
      {
