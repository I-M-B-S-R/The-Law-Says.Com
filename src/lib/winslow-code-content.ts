...
export const WINSLOW_CODE_CONTENT: Record<string, CodeContent> = {
  '1': {
    summary: "Title I of the Winslow City Code establishes the foundational legal framework for the entire code. It provides rules for interpretation, defines common terms, and specifies the general penalty for violations where a specific penalty is not provided.",
  ...
  '7': {
    summary: "Title VII is the Winslow Traffic Code. It adopts state traffic laws and establishes additional local regulations for vehicle operation and parking.",
    purpose: "To provide for the safe and orderly movement of vehicular and pedestrian traffic within the City of Winslow.",
    keyProvisions: [
      {
    ...
    keyProvisions: [
      {
        ...
        content: "Requires most businesses operating in Winslow to obtain a City Business License."
      }
    ]
  },
  '13': {
    ...
    purpose: "To define and prohibit conduct that is harmful to public peace, safety, and order within the City of Winslow.",
    keyProvisions: [
      {
  ...
  '15': {
    summary: "Title XV, Land Usage, contains the comprehensive Zoning and Subdivision regulations for the city. It is the primary tool for managing growth and ensuring development aligns with the city's character as a historic railroad and Route 66 town.",
    ...
    keyProvisions: [
      ...
      },
      {
        ...
        content: "Includes regulations aimed at preserving the unique historic character of Winslow's downtown and commercial areas."
      }
    ]
  }
};
