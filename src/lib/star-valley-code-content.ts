...
export const STAR_VALLEY_CODE_CONTENT: Record<string, CodeContent> = {
  '10': {
    summary: "Chapter 10 of the Star Valley Town Code establishes the foundational legal framework for the entire code. It provides rules for interpretation, defines common terms, and specifies the general penalty for violations where a specific penalty is not otherwise stated.",
  ...
  '151': {
    summary: "Chapter 151, the Zoning Ordinance, is the primary tool for regulating land use and development within the Town of Star Valley.",
