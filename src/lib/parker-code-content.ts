...
export const PARKER_CODE_CONTENT: Record<string, CodeContent> = {
  '1': {
    summary: "Title I of the Parker Town Code establishes the foundational legal framework for all other titles. It provides rules for interpreting the code, defines common terms, and specifies the general penalty for violations where a specific penalty is not otherwise stated.",
  ...
  '5': {
    summary: "Title V, Public Works, governs the essential infrastructure and services managed by the town, including regulations for streets, public property, and utilities, which are vital for a community on the Colorado River.",
  ...
  '7': {
    summary: "Title VII is the Parker Traffic Code. It adopts state traffic laws and establishes additional local regulations for vehicle operation and parking, particularly important in a town with significant tourist and recreational traffic.",
    purpose: "To provide for the safe and orderly movement of vehicular and pedestrian traffic within the Town of Parker.",
    keyProvisions: [
      {
      ...
      },
      {
        ...
        content: "Prohibits parking in certain areas and for extended periods on public streets to ensure safety and access, especially during major events like boat races."
      }
    ]
  },
  '9': {
    ...
    keyProvisions: [
      {
        ...
        content: "Requires most businesses operating in Parker to obtain a Town Business License."
      },
      {
        title: "Special Events",
        content: "A Special Event Permit is required for temporary events, which are a major part of Parker's economy, to ensure public safety and coordination of town services."
      }
    ]
  },
  '13': {
    ...
    purpose: "To define and prohibit conduct that is harmful to public peace, safety, and order within the Town of Parker.",
    keyProvisions: [
      {
      ...
      },
      {
        ...
        content: "Regulates the consumption of alcoholic beverages in public places, particularly along the riverfront and in parks."
      }
    ]
  },
  '15': {
    summary: "Title XV, Land Usage, contains the comprehensive Zoning and Subdivision regulations for the town. It is the primary tool for managing growth and ensuring development aligns with the town's character as a riverfront community.",
    purpose: "To guide the physical development of the town in a manner that promotes public health and safety, ensures orderly growth, and capitalizes on its location on the Colorado River.",
    keyProvisions: [
      {
        title: "Zoning Districts",
        content: "Establishes various residential, commercial, and industrial zoning districts, including specific zones for riverfront development, and specifies the permitted uses, density, and development standards for each."
      },
      {
      ...
      },
      {
        ...
        content: "Includes critical regulations for development within the Colorado River floodplain to minimize flood risk and protect property."
      }
    ]
  }
};
