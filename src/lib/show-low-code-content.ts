...
export const SHOW_LOW_CODE_CONTENT: Record<string, CodeContent> = {
  '1': {
    summary: "Title 1 of the Show Low City Code establishes the foundational legal framework for the entire code. It provides rules for interpretation, defines common terms, and specifies the general penalty for violations where a specific penalty is not provided.",
    ...
    keyProvisions: [
      {
        ...
        content: "Requires most businesses operating in Show Low to obtain a City Business License."
      },
      {
    ...
    keyProvisions: [
      {
        ...
        content: "Requires all dogs to be licensed with Navajo County and vaccinated against rabies, which is enforceable within city limits."
      },
      {
  ...
  '8': {
    summary: "Title 8, Health and Safety, covers a wide range of rules related to public health and welfare, including nuisance abatement and fire regulations.",
    ...
    keyProvisions: [
      ...
      },
      {
        ...
        content: "Includes regulations on open burning and other fire hazards, critical for a city located in a heavily forested area."
      }
    ]
  },
  '9': {
