...
export const QUEEN_CREEK_CODE_CONTENT: Record<string, CodeContent> = {
  '1': {
    summary: "Title I of the Queen Creek Town Code establishes the foundational legal framework for the entire code. It provides rules for interpretation, defines common terms, and specifies the general penalty for violations where a specific penalty is not otherwise stated.",
  ...
  '7': {
    summary: "Title VII is the Queen Creek Traffic Code. It adopts state traffic laws and establishes additional local regulations for vehicle operation and parking.",
    purpose: "To provide for the safe and orderly movement of vehicular and pedestrian traffic within the Town of Queen Creek.",
    keyProvisions: [
      {
    ...
    keyProvisions: [
      {
        ...
        content: "Requires most businesses operating in Queen Creek to obtain a Town Business License."
      },
      {
        title: "Special Events",
        content: "A Special Event Permit is required for temporary events that affect ordinary public access or services."
      }
    ]
  },
  '13': {
    ...
    purpose: "To define and prohibit conduct that is harmful to public peace, safety, and order within the Town of Queen Creek.",
    keyProvisions: [
      {
  ...
  '15': {
    summary: "Title XV, Land Development Code, contains the comprehensive Zoning and Subdivision regulations for the town. It is the primary tool for managing growth while preserving the town's unique equestrian and agricultural heritage.",
    purpose: "To guide the physical development of the town in a manner that promotes public health, safety, and welfare, while protecting the town's community character and ensuring orderly growth.",
    keyProvisions: [
      {
