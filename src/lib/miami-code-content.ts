...
export const MIAMI_CODE_CONTENT: Record<string, CodeContent> = {
  '1': {
    summary: "Title I of the Miami Town Code establishes the foundational legal framework for all other titles. It provides rules for interpreting the code, defines common terms, and specifies the general penalty for violations where a specific penalty is not otherwise stated.",
  ...
  '7': {
    summary: "Title VII is the Miami Traffic Code. It adopts state traffic laws and establishes additional local regulations for vehicle operation and parking.",
    purpose: "To provide for the safe and orderly movement of vehicular and pedestrian traffic within the Town of Miami.",
    keyProvisions: [
      {
    ...
    keyProvisions: [
      {
        ...
        content: "Requires most businesses operating in Miami to obtain a Town Business License."
      }
    ]
  },
  '13': {
    ...
    purpose: "To define and prohibit conduct that is harmful to public peace, safety, and order within the Town of Miami.",
    keyProvisions: [
      {
  ...
  '15': {
    summary: "Title XV, Land Usage, contains the comprehensive Zoning and Subdivision regulations for the town. It is the primary tool for managing growth and ensuring development aligns with the town's character as a historic mining community.",
    purpose: "To guide the physical development of the town in a manner that promotes public health and safety and ensures orderly growth while respecting its historic context.",
    keyProvisions: [
      {
      ...
      },
      {
        ...
        content: "Includes regulations aimed at preserving the unique historic character of Miami's commercial and residential areas."
      },
      {
