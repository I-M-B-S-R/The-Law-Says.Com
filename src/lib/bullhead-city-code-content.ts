...
export const BULLHEAD_CITY_CODE_CONTENT: Record<string, CodeContent> = {
  '1': {
    summary: "Title 1 of the Bullhead City Code establishes the foundational legal principles for the entire code. It includes rules for interpretation, definitions of common terms, and the general penalties for violations.",
    ...
    keyProvisions: [
      ...
      },
      {
        ...
        content: "Establishes a default penalty for any violation of the City Code where a specific penalty is not otherwise provided."
      },
      {
        title: "Severability",
  ...
  '2': {
    summary: "Title 2 outlines the structure and administrative procedures of the city government, establishing the roles of the City Council, City Manager, and various departments.",
    purpose: "To establish a clear and efficient framework for the governance of the City of Bullhead City, ensuring accountability and the orderly conduct of public business.",
    keyProvisions: [
      {
      ...
      {
        title: "City Council",
        content: "The City Council is the legislative body, consisting of a directly elected Mayor and six Council members elected at large."
      },
      {
    ...
    keyProvisions: [
      {
        ...
        content: "All businesses operating in Bullhead City must obtain a City Business License and a Transaction Privilege Tax (TPT) license from the Arizona Department of Revenue."
      },
      {
  ...
  '6': {
    summary: "Title 6 establishes the rules for the keeping of animals within the city to protect public safety and ensure animal welfare.",
    ...
    keyProvisions: [
      {
        ...
        content: "The city adopts the comprehensive traffic laws of the State of Arizona by reference, making them fully enforceable within Bullhead City."
      },
      {
        title: "Parking Rules",
      ...
      {
        title: "Off-Highway Vehicles (OHVs)",
        content: "Regulates the operation of OHVs on city streets, generally limiting them to streets with lower speed limits to provide access to trails."
      }
    ]
  },
  '12': {
