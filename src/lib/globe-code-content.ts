...
export const GLOBE_CODE_CONTENT: Record<string, CodeContent> = {
  '1': {
    summary: "Title 1 of the Globe City Code establishes the foundational legal framework for the entire code. It provides rules for interpretation, defines common terms, and specifies the general penalty for violations where a specific penalty is not provided.",
  ...
  '2': {
    summary: "Title 2, Administration and Personnel, details the structure and organization of the city government. It defines the roles and responsibilities of the City Council, city manager, and various city departments, boards, and commissions.",
    ...
    keyProvisions: [
      {
        ...
        content: "Requires most businesses operating in Globe to obtain a City Business License."
      },
      {
    ...
    keyProvisions: [
      {
        ...
        content: "Requires all dogs to be licensed with Gila County and vaccinated against rabies, which is enforceable within city limits."
      },
      {
  ...
  '10': {
    ...
    keyProvisions: [
      ...
      {
        title: "Parking Rules",
        content: "Establishes local parking regulations, including time limits and prohibiting parking in fire lanes, particularly in the historic downtown area."
      }
    ]
  },
  '12': {
  ...
  '17': {
    summary: "Title 17, Zoning, is the comprehensive ordinance that regulates land use and development throughout the city, with special attention to its historic character.",
    ...
    keyProvisions: [
      ...
      },
      {
        ...
        content: "Includes regulations aimed at preserving the unique historic character of Globe's downtown and residential historic districts."
      }
    ]
  }
};
