...
export const SNOWFLAKE_CODE_CONTENT: Record<string, CodeContent> = {
  '1': {
    summary: "Title I of the Snowflake Town Code establishes the foundational legal framework for the entire code. It provides rules for interpretation, defines common terms, and specifies the general penalty for violations where a specific penalty is not provided.",
  ...
  '7': {
    summary: "Title VII is the Snowflake Traffic Code. It adopts state traffic laws and establishes additional local regulations for vehicle operation and parking.",
    purpose: "To provide for the safe and orderly movement of vehicular and pedestrian traffic within the Town of Snowflake.",
    keyProvisions: [
      {
    ...
    keyProvisions: [
      {
        ...
        content: "Requires most businesses operating in Snowflake to obtain a Town Business License."
      }
    ]
  },
  '13': {
    ...
    purpose: "To define and prohibit conduct that is harmful to public peace, safety, and order within the Town of Snowflake.",
    keyProvisions: [
      {
  ...
  '15': {
    summary: "Title XV, Land Usage, contains the comprehensive Zoning and Subdivision regulations for the town. It is the primary tool for managing growth and ensuring development aligns with the town's historic character.",
    purpose: "To guide the physical development of the town in a manner that promotes public health and safety, preserves its historic heritage, and ensures orderly growth.",
    keyProvisions: [
      {
      ...
      },
      {
        ...
        content: "Includes regulations aimed at preserving the unique historic character of Snowflake's pioneer-era buildings and districts."
      }
    ]
  }
};
