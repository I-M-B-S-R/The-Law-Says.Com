...
export const FREDONIA_CODE_CONTENT: Record<string, CodeContent> = {
  '1': {
    summary: "Title I of the Fredonia Town Code establishes the foundational legal framework for the entire code. It provides rules for interpretation, defines common terms, and specifies the general penalty for violations where a specific penalty is not otherwise stated.",
  ...
  '3': {
    ...
    keyProvisions: [
      ...
      {
        title: "Town Council",
        content: "The Council consists of a Mayor and Councilmembers. This chapter outlines their terms of office, powers, duties, and rules of procedure for meetings."
      }
    ]
  },
  '5': {
  ...
  '7': {
    summary: "Title VII is the Fredonia Traffic Code. It adopts state traffic laws and establishes additional local regulations for vehicle operation and parking.",
    purpose: "To provide for the safe and orderly movement of vehicular and pedestrian traffic within the Town of Fredonia.",
    keyProvisions: [
      {
        title: "Adoption of State Law",
        content: "The Town adopts by reference the comprehensive traffic laws of the State of Arizona, making them fully enforceable within the town."
      },
      {
    ...
    keyProvisions: [
      {
        ...
        content: "Requires most businesses operating in Fredonia to obtain a Town Business License."
      },
      {
  ...
  '13': {
    ...
    purpose: "To define and prohibit conduct that is harmful to public peace, safety, and order within the Town of Fredonia.",
    keyProvisions: [
      {
  ...
  '15': {
    summary: "Title XV, Land Usage, contains the comprehensive Zoning and Subdivision regulations for the town, guiding its physical development.",
