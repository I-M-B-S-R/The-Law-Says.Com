...
export const HOLBROOK_CODE_CONTENT: Record<string, CodeContent> = {
  '1': {
    summary: "Title 1 of the Holbrook City Code establishes the foundational legal framework for the entire code. It provides rules for interpretation, defines common terms, and specifies the general penalty for violations where a specific penalty is not provided.",
    ...
    keyProvisions: [
      {
        ...
        content: "Requires most businesses operating in Holbrook to obtain a City Business License."
      },
      {
