// src/data.js
export const federalTitles = [
  { 
    number: 1, 
    description: "General Provisions",
    chapters: [
      { number: 1, name: "Rules of Construction" },
      { number: 2, name: "Acts and Resolutions; Formalities of Enactment; Repeals; Sealing of Instruments" },
      { number: 3, name: "Code of Laws of United States and Supplements; District of Columbia Code and Supplements" }
    ]
  },
  { 
    number: 2, 
    description: "The Congress",
    chapters: [
      { number: 1, name: "Election of Senators and Representatives" },
      { number: 2, name: "Organization of Congress" },
      { number: 3, name: "Compensation and Allowances of Members" },
      { number: 4, name: "Officers and Employees of Senate and House of Representatives" }
    ]
  },
  ...
  { number: 36, description: "Patriotic and National Observances" },
  ...
  { number: 53, description: "Reserved" },
  { number: 54, description: "National Aquaculture Policy" }
];